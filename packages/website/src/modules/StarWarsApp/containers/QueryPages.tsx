...
const FilmInfoWithQuery = withQuery(filmQuery, ({ getFilm }) => (
  <FilmInfo {...getFilm} />
))
const SpeciesInfoWithQuery = withQuery(speciesQuery, ({ getSpecies }) => (
  <SpeciesInfo {...getSpecies} />
))
const PersonInfoWithQuery = withQuery(personQuery, ({ getPerson }) => (
  <PersonInfo {...getPerson} />
))
const PlanetInfoWithQuery = withQuery(planetQuery, ({ getPlanet }) => (
