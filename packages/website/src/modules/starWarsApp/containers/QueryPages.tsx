...
const SpeciesInfoWithQuery = withQuery(speciesQuery, ({ getSpecies }) => <SpeciesInfo {...getSpecies} />)
...
const StarshipInfoWithQuery = withQuery(starshipQuery, ({ getStarship }) => <StarshipInfo {...getStarship} />)
const VehicleInfoWithQuery = withQuery(vehicleQuery, ({ getVehicle }) => <VehicleInfo {...getVehicle} />)
